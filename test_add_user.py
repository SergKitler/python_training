...
class test_add_user(unittest.TestCase):
    ...
    def test_test_add_user(self):
        ...
        self.add_new_user(wd, firstname="Ivan", middlename="Ivanovich", lastname="Sidorov", nickname="TestUser", title="test", company="TestingGroup",
    ...
    def add_new_user(self, wd, firstname, middlename, lastname, nickname, title, company, email, byear):
